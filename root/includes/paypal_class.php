...
//		$this->fields["TAXAMT"]         = $this->EC_data["TAXAMT"];
	...
	{
		global $db;
		// to cancel Recurring Payment Profile created with Express Checkout you have to call ManageRecurringPaymentsProfileStatus 	
...
//    		$messenger->save_queue();
	...
	private function process_request($data)
    {
		...
		elseif ($result<400)
        {
            ...
            $this->debug(__FILE__, __LINE__, $this);            
