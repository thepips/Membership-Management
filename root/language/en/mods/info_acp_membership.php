...
$lang = array_merge($lang, array(
	...
	'CHANGE'						=> 'Change Premium Group',
	'DEFAULT_GROUP'					=> 'Set Group as default',
	'DEFAULT_GROUP_EXPLAIN'			=> 'If set then the premium premium membership group is set as the default group for the user',
	...
	'ERROR_GROUP'					=> 'User group record missing',
	'ERROR_MEMBERSHIP'				=> 'User membership record missing',
	...
	'NO_CLUB_MEMBERS'				=> 'No Premium Members',
	'NO_RENEWAL_DATE'				=> 'Missing Renewal Date',
	'NOT_MEMBERS'					=> 'Not members',
	'OVERDUE'						=> 'Overdue Premium Members',
	...
	'PREMIUM_GROUP'					=> 'Premium Group',
	'PREMIUM_GROUP_EXPLAIN'			=> 'The premium group the member has joined',
	'RANK'							=> 'Rank',
	'RANK_EXPLAIN'					=> 'Users will be given this rank when they become premium members',
	'JOIN'							=> 'Join',
	'REGISTRATION'					=> 'Enable Premium Membership during registration',
	'REGISTRATION_EXPLAIN'			=> 'Allow new users to enroll for premium membership as they register.<BR />
Please note that this option is only active if<BR />
A. The Membership Module is active<BR />
B. Account activation is set to NONE',
	'NEVER'							=> 'Never',
	'OPTIONAL'						=> 'Optional',
	'ALWAYS'						=> 'Always',
	'REMOVE'						=> 'Remove',
	...
	'SORT_DATE_JOINED'				=> 'Date Joined',
	'SORT_GROUP'					=> 'Premium Group',
